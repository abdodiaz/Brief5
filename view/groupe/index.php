                ...
                <div id="salleForm">
                    ...
                    <form action="create" method="Post">
                        ...
                        <div class="col-md-12 text-center">
                            <input type="submit" class="btn btn-dark" id="buttonadd" value="Add" name="ajouter">
                        </div>
                        ...
                        foreach ($result as $res) { ?>
                            <form action="update" method="POST">
                                <tr>
                                    ...
                                    <td>
                                        <label id="libellelabel<?= $i ?>" for=""><?php echo $res['libelle_g'] ?></label>
                                        <input type="text" id="libellee<?= $i ?>" value="<?php echo $res['libelle_g'] ?>" name="libelle_g" style="display:none">
                                    </td>
                                    <td>
                            ...
                            <form action="groupe/delete" method="post">
